...
const universityList= ['Univerisity of Toronto St.George'];
universityList.push('Univerisity of Toronto Missisauga');
universityList.push('Ryerson Univerisity');
universityList.push('George Brown College');
universityList.push('Stanford University');
universityList.push('Harvard Univerisity');
universityList.push('Univerisity of California Berkley');
universityList.push('York Univerisity');
